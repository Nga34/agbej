...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim tôi đang đập nhanh " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
// Phần popup khi bạn nhấn vào nút "Nhịp tim của mình hiện là"
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nhịp tim như vậy là tại vì:';
document.querySelector('.Description .modal-body').innerHTML = 'hihi ngại quá:))) <i class="fas fa-heart"></i> ';
